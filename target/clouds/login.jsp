				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
							<td align="center" style="font-weight: bold;color: gray;">登录－管理系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
							alt="Logo"></td>
					</tr>
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly" style="background: #28b779"><img
							...
							alt="请输入账号.."></span><input type="text" placeholder="用户名" name="username" id="username"
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><img
							...
							alt="请输入密码.."></span><input type="password" placeholder="密码" name="password" id="password"
							style="height: 32px; margin-bottom: 0px;"/>
					</div>
				</div>
			</div>
...
//			document.loginform.submit();
			...
			window.location.href="http://localhost:8888/cas/registerLogin?username="+username+"&password="+password+"&service=http://localhost:8080/index.shtml";
		}
		function to_top(){
			if(window != top){
