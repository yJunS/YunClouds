...
<input id="txtGroupsSelect" type="hidden" value="${txtDeptSelect}"
			name="txtGroupsSelect" />
	<label for="host" class="col-sm-3 control-label">部门</label>
	<div class="col-sm-9">
			...
			<tbody>
				...
				<tr>
					<td><select id="selectGroups" multiple="multiple"
						...
						<c:forEach items="${userDept}" var="key">
