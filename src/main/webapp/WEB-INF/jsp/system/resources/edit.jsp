...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		...
		<input type="hidden" value="${resources.id}" name="ResourcesFormMap.id"
			id="id">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select id="parentId" name="ResourcesFormMap.parentId"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input id="gritter-light" type="checkbox"
						...
						name="ResourcesFormMap.ishide" id="ishide"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						placeholder="请输入菜单描述" name="ResourcesFormMap.description"
