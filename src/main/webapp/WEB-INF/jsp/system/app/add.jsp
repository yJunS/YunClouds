...
<script type="text/javascript" src="${ctx}/js/system/app/add.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/app/addEntity.shtml">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control"
						placeholder="请输入第三方服务名" name="appFormMap.appName" id="name">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入第三方服务链接"
						name="appFormMap.appServer" id="appServer">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入校验码"
						   name="appFormMap.yzKey" id="yzKey">
				</div>
			</div>
					...
					<div class="btn-group m-r">
						...
						<ul class="dropdown-menu dropdown-select">
							<li class=""><a href="#"><input type="radio"
									name="appFormMap.state" value="0" checked="checked">是</a></li>
							<li class="active"><a href="#"><input type="radio"
									name="appFormMap.state" value="1">否</a></li>
						</ul>
					</div>
				</div>
			</div>
