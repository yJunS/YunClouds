...
<input id="txtGroupsSelect" type="hidden" value="${txtTypeSelect}"
			name="txtGroupsSelect" />
	<label for="host" class="col-sm-3 control-label">公司类型</label>
	<div class="col-sm-9">
			...
			<tbody>
				...
				<tr>
					<td><select id="selectGroups" multiple="multiple"
						...
						<c:forEach items="${userType}" var="key">
